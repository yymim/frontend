...
// let exactString = 'hello'; => string
// let exactNumber = 10; => number
// let exactBoolean = true; => boolean
...
type Directions = "up" | "down" | "left" | "rignt";

let moveUp: Directions = "up";
moveUp = "down";
moveUp = "left";

console.log(moveUp); // left 출력
// let moveBottom: Directions = 'down'; -> Type Error
