...
if (number > 0) console.log("The n is p");
else console.log("The n is not p");
...
// switch (식) {
  // case 값1:
    // 식이 값 1과 일치할 때 실행되는 코드
    // break;
  // case 값 1:
    // 식이 값 2와 일치할 때 실행되는 코드
    // break;
  // ...
  // default;
...
// >> true가 될 확률이 높은 조건식을 첫 번째 조건식으로 사용하는 것을 권장
