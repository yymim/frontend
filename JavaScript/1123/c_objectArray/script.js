...
object.name || console.log('name 속성이 없습니다.'); // 실행X
object.hobby || console.log('hobby 속성이 없습니다.'); // 실행O
...
object.favorite = object.favorite || '황도';
...
// 출력
console.log(물건_1123); // '['우유', '식빵', '고구마', '토마토']' 출력
console.log(물건_1124); // '['우유', '식빵', '고구마', '토마토']' 출력
...
console.log(JSON.stringify(puppyD));