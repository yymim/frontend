// input 텍스트 필드와 단락을 포함하고 있는 HTML 두 요소에 대한
...
// 양수의 값이 매개변수로 전달
// 음수가 들어올 경우 - 계산하지않음 (반환 undefined)
// 0 이 들어올 경우 - 계산하지 않음 (반환 1)
...
input.addEventListener('change', () => {
  ...
  if (isNaN(num)) {
    // num이 NaN일 경우
    // html 요소의 textContet 속성을 사용하는 경우
