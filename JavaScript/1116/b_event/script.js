...
// 이벤트 객체인 e를 함수에 포함하고, 이벤트객체의 target프로퍼티를 사용하여 이벤트가 일어나는 버튼 그 자체에 실행
// 매개변수 bgChange에 event 객체를 전달받아서
...
// 이벤트 객체 실습
// : 16개의 타일 세트
// : querySelectorAll()을 사용하여 16개의 타일의 참조를 div상수에 할당
...
// divs에 담긴 .tile 요소들을 순회하기 위한 반복
for (let i = 0; i < divs.length; i++) {
  // 각 .tile 요소에 onclick 이벤트 핸들러 할당
...
// 예) HTML 페이지에서 버튼 요소가 클릭되면 버튼요소부터 시작해서 그의 부모요소들을 거쳐서 최상위 요소까지 전달
