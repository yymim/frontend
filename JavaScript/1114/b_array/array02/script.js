...
// 데이터 사이에는 ', '
// let cars = ['audi', 'bmw', 'hyundai', 'volvo'];
let combinedCarsNames = cars.reduce(
  (accumulator, currentValue) => accumulator + ', ' + currentValue
);

console.log(combinedCarsNames);
...
// 해당 함수가 리턴하는 값이
// - 0보다 작을 경우 : a가 b보다 앞에 오도록 정렬(오름차순)
// - 0보다 클 경우 : b가 a보다 앞에 오도록 정렬(내림차순)
// - 0일 경우 : 순서 변경 X
...
//? 3. toString, toLocaleString (지역 설정에 맞는 문자열로 변환 - 예.날짜)
// : 배열을 문자열로 변환
