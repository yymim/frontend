...
//! 배열의 생성 및 초기화
//? 1. 배열 리터럴 형식
// : 대괄호([])를 사용하여 생성, 내부의 값을 쉼표로 구분하여 입력
...
let arrayLenghTwo = new Array(2);
let arrayWithTwo = new Array('2');
console.log(arrayLenghTwo); // 길이가 2인 빈 배열
...
console.log(matrix[0][1]); // 0번째 요소의 2번째 요소
console.log(matrix[2][2]); // 2번째 요소의 2번째 요소
...
// : 생략 시에는 삽입되지 X
console.log(cars);
// ['newBMW', 'audi', 'hyundai', empty × 4, 'kia']
