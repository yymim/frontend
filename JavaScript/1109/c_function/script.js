...
log(); // 아규먼트를 넘기지 않음 - 출력 : undefined
log(1); // 인수를 하나 넘김 - 출력 : 1
log(1, 2); // 인수를 두 개 이상 넘김 - 출력 : 1 (지정된 수의 파라미터 이상의 인수는 읽히지 않음)
...
console.log(lsa());
console.log(job); // Error 지역변수라서 그럼