...
document.addEventListener('DOMContentLoaded', () => {
  ...
  a.textContent = '<h2>textContent 속성</h2>'; // -> 태그도 문자열 그대로 출력
  b.innerHTML = '<h2>textContent 속성</h2>'; // -> HTML 형식으로 변환하여 출력
})

//! 속성 조작하기
// : 문서 객체의 속성을 조작

//? 문서객체.setAttribute(속성이름, 속성값)
// : 특정 속성에 값을 지정
...
// : 속성명의 경우
// : >> JS는 식별자에 -(하이픈)기호를 사용 불가
// : >> lowerCamelCase를 사용하여 표기
    /*
      CSS의 경우 속성명 작성 시
      : 단어와 단어 사이를 하이픈(-)으로 구분
    */
// text-align -> textAlign / font-size -> fontSize

//? 스타일 객체 사용법
// : 주로 점표기법을 사용
// h1.style.backgroundColo: 점표기법을 사용
