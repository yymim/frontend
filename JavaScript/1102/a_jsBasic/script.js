...
// 식별자 뒤에 괄호 없는 경우 : 변수(단독 사용), 속성(다른 식별자와 사용)
// 식별자 뒤에 괄호 있는 경우 : 함수(단독 사용), 메소드(다른 식별자와 사용)
...
//? 알림 창(대화상자) 출력 (alert : 알리다, 경고하다)

// alert()함수 사용
// : 소괄호 안에 출력할 메시지를 입력(매개변수, parameter)
alert('hello world!');

//? 확인 창 출력하기 (confirm : 확인하다)
...
// 괄호 안에는 실제 웹 브라우저 화면에 표시할 내용 (HMTL 태그 사용 가능), 어떤 결괏값이 저장된 변수 삽입 가능
//document.write();
